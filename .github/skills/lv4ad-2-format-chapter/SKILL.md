...
description: >-
  ...
  personal annotation into its own `[[My Note]]` child bullet in italics. Use
  when the user asks to format, clean up, restructure, or "make it match my
  style" for an [[LV4AD/Ch/...]] page that already has raw/flat highlights. Does
  not fetch new highlights (lv4ad-1-import-chapter) and does not add links to
  other garden entities (lv4ad-3-enrich-links).
---
