---
description: >-
  Log a podcast episode using Person/Pod/YY/MM EpisodeTitle, ensure
  Person/Podcast page aliases, and add a journal entry for a specified date
trigger: /logseq-podcast-episode
turbo: true
---
# Workflow: /logseq-podcast-episode
