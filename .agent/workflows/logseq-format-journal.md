---
description: >-
  Format journal entries with editorial-style headings evocative of Harper's
  Magazine, The Economist, and The New Yorker
trigger: /logseq-format-journal
turbo: true
---
# Workflow: /logseq-format-journal
