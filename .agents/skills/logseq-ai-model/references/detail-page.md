...
This extends the singular naming convention for creating comprehensive AI model documentation pages.

## When to Use
- Creating detailed model documentation for a specific model version
- Documenting model capabilities and benchmarks for a particular release
- Creating model comparison pages
...
- Follow the singular naming convention
...
## Quick-mention format
For mentioning models in passing, changelogs, comparisons, or stubs, see the SKILL.md body (provider namespaces, version hierarchy, stub-page shape).
