alias:: [[AI Knowledge Gardening]], [[AI/Knowledge/Gardening]], [[Ghost Gardener]], [[Ghost Gardeners]] 
tags:: [[Term]]
...
- # AI [[Knowledge Gardening]]
  id:: 67c44a8f-6b18-4101-b5b5-c2105744ddcb
	...
	- In a playful spirit, I like to call these [[Ghost Gardeners]]. I may ask that a Ghost Gardener maintains some part of the garden.
	- If I put [[Ghost Gardener]] as a tag on a block that contains a [[logseq/todo]] then if I ask an AI agent to be a ghost gardener for that page, it should consider itself assigned that todo and handle that todo, updating it appropriately, but not continue to todos outside of that page, as I may have other agents handling those.
