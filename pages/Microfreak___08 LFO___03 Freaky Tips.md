...
- # 08.3 Freaky Tips and Tricks
	- Use the LFO to modulate both the filter cutoff and the envelope attack and decay times. Filter cutoff is a standard Matrix connection; assign the envelope attack and decay destinations explicitly in the Matrix. See the section about the Matrix for details.
	...
	- Use the rising sawtooth to modulate the decay time of the Standard or Cycling Envelope for more realistic drum or bell sounds. The Cycling Envelope's attack and fall shapes can also change dynamically from linear to exponential. See the Envelope Generator chapter for details.
