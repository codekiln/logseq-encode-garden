...
- # Terminal-first toolbelt learning: snips, flashcards, coaches, Readwise-style reading
	...
	- ## Coaches (concept)
		...
		- [[Learning/Idea/26/03/Terminal toolbelt learning and Readwise-like CLI/Proto Session/26/03/25 Wed]] — zsh × tmux refresh constraints + garden `rg` ladder; coach withholds playbook.
