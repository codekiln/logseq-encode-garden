...
- # Agentic Coding Plugin Systems and Cross-Provider Portability
	- ## Scope, date, and executive findings
		...
		- The central finding is that the [[AI/Coding/Tool/Report/25/Skills Comparison]] conclusion that Claude Code was effectively unique is no longer valid. Claude Code remains the most mature reference implementation, but several systems now provide comparable installable bundles:
