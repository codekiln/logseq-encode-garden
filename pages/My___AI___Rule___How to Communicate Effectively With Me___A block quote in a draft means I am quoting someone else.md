...
- When AI drafts a [[Slack]] post, a [[JIRA]] comment, a [[GitHub]] comment or an email for me to send, the draft is plain markdown: paragraphs, bullets, links, and a fenced code block where code is the point. I have AI write these in a markdown document precisely so that I can copy them out and paste them where they are going.
