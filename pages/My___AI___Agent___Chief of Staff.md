...
- # Chief of Staff
	...
	- ## What produces no error in a graph
		...
		- ### A deep link from another repo that lands nowhere
			- [[My/Dotfiles]] annotates each tool it installs with a `logseq://graph/logseq-encode-garden?page=<Page>` link to the page where that tool is being learned, per [[My/Dotfiles/openspec/specs/garden-entity-links]]. Those links name 102 distinct pages in this graph, and four of them arrive nowhere: `tmux/Keyshort/Pane/Resize` falls one word short of [[tmux/Keyshort/Pane/Resize Pane]], `My/AI/Rule/` ends on a bare slash, and `tmux/Q/Why` and `JetBrains/Font/Mono` name no page at all.
