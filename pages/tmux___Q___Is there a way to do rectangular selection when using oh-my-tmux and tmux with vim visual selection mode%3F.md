	...
	- ## Answer
		- [[AI/Response]]
			...
			- ### Vim-like bindings (recommended)
				- If oh-my-tmux has already bound `v` to `begin-selection`, rectangle mode can be unavailable unless you add explicit bindings. In `.tmux.conf.local` (oh-my-tmux's user override), you can make it behave like vim:
