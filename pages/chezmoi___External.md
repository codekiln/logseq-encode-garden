...
- # [chezmoi External Files](https://www.chezmoi.io/user-guide/include-files-from-elsewhere/)
	...
	- ## Usage in this dotfiles repo
		- [[tmux/oh-my-tmux]] is managed this way
			- Source: `chezmoi/dot_local/share/tmux/.chezmoiexternal.toml`
			- Clones to: `~/.local/share/tmux/oh-my-tmux/`
			- See [[tmux/oh-my-tmux/Installation]] for the full setup
	- ## Chezmoi symlinks
		...
		- Example: `chezmoi/dot_config/tmux/symlink_tmux.conf` containing `../../.local/share/tmux/oh-my-tmux/.tmux.conf`
		  creates `~/.config/tmux/tmux.conf → ../../.local/share/tmux/oh-my-tmux/.tmux.conf`
