...
- # Proto Session — [[2026-03-25 Wed]] — AI Terminal Coach (zsh × tmux × garden search)
	- Continues [[Learning/Idea/26/03/Terminal toolbelt learning/Proto Session/26/03/21 Sat]]: short coach turns, user runs commands first, coach reacts to paste or pane capture where applicable.
