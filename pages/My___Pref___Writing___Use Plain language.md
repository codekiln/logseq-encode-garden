...
- # Plain language
	...
	- ## Tips
		...
		- | Metric | Target | Why |
		  | ---- | ---- | ---- |
		  | Flesch Reading Ease | **60-80** | Comfortable for most educated adults; many plain-language guides recommend around 60-70. ([kstatelibraries.pressbooks.pub](https://kstatelibraries.pressbooks.pub/techforhumans/chapter/surveillance-nichols/)) |
		  | Flesch-Kincaid Grade Level | **6-8** | Appropriate for general audiences; many government and health organizations target this range. ([epa.gov](https://www.epa.gov/choose-fish-and-shellfish-wisely/readability-developing-and-pretesting-concepts-messages-materials)) |
		  | Average sentence length | **12-18 words** | Easier to process than long, nested sentences. |
		  | Paragraph length | **1-4 sentences** | Improves scanning. |
		  | Technical terms | **Define on first use** | Never assume domain knowledge. |
	...
	- ## How to write
		...
		- Use active voice.
		- Spell out an acronym before you abbreviate it.
