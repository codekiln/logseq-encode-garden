...
- # What Is a **Shim** in [[mise]]? [Shims | mise-en-place](https://mise.jdx.dev/dev-tools/shims.html)
	...
	- ## Key Principles
		...
		- **Environment on demand** – [[mise/Config/mise.toml/env]] load *only when a shim runs*; they are not present for unrelated commands. See [Shims: Environment](https://mise.jdx.dev/dev-tools/shims.html).
