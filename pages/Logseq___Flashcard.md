...
- ## Usage
	- To create a card:
		...
		- You can right click the bullet to "Make a Flashcard", which will add `#card` to the end of the current block.
		  logseq.order-list-type:: number
			- ![../assets/sidebar-make-a-flashcard.png](https://raw.githubusercontent.com/logseq/docs/refs/heads/master/assets/sidebar-make-a-flashcard.png)
		...
		- It's just a block with either `#card` or `[[card]]`. It can have some [[Clozes]] too.
			- For example, this block is a card:
				...
				- If you right click the bullet and select "Preview Card", you'll see something like this:
					- ![CleanShot 2021-07-22 at 21.46.52.png](https://raw.githubusercontent.com/logseq/docs/refs/heads/master/assets/CleanShot_202021-07-22_20at_2021.46.52_1626961624975_0.png)
