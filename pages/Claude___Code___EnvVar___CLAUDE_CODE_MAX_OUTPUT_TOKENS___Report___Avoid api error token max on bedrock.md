...
title:: Claude/Code/EnvVar/CLAUDE_CODE_MAX_OUTPUT_TOKENS/Report/Avoid api error token max on bedrock
...
- # Handling "Claude's Response Exceeded the 4096 Output Token Maximum" in Claude Code via Amazon Bedrock: Causes, Best Practices, and Mitigation Strategies
	...
	- ## Best Practices and Configuration Guidelines
		...
		- ### 2. Recommended Token Budgets
			- See also [[AWS/Builder/Center/Blog/25/02/Claude Code on Amazon Bedrock Quick Setup Guide]] which recommends this
	...
	- ## Production Configuration Templates
		- ### Minimal: Baseline
			- [[AWS/Builder/Center/Blog/25/02/Claude Code on Amazon Bedrock Quick Setup Guide]]
			- **.env**
				- ```
				  CLAUDE_CODE_MAX_OUTPUT_TOKENS=4096
				  MAX_THINKING_TOKENS=1024
