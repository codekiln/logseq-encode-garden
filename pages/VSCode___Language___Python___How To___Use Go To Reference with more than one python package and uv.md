# How to use [[VSCode/Command/Go To/References]] in a project with more than one package that's using [[uv]]
	- ## Problem Context
		- [[PyPoetry]] has dedicated support for installing packages in editable mode with `develop = true` in [[Py/pyproject.toml]]; see also [[PyPoetry/Concept/Misconception - Disadvantages of Pip vs Poetry]]
