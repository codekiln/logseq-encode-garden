...
- # Wishlist
	- Upstream feature ideas for [[GitHub/CLI/Extension/gh-dash]] — candidates for a future issue or PR against [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash).
	- ## Mark PR as draft (inverse of ready for review)
		- [[GitHub/CLI/Extension/gh-dash/Q/Does gh-dash have a keyshort like W ready for review which is the inverse (mark as draft)?]]
