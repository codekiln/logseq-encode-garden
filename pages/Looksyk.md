...
- # [SebastianRzk/Looksyk: A markdown centric, fast and local personal knowledge platform - Codeberg.org](https://codeberg.org/SebastianRzk/Looksyk)
	...
	- [[My Notes]]
		...
		- [[2026-06-30 Tue]]
			...
			- I seem to recall that there's no support for importing tags with `#tag` from logseq pages; it only supports `[[double bracket style links]]`, but now I can't find it.
