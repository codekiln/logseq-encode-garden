...
- # What's the difference between [[mise/unuse]], [[mise/uninstall]], and [[mise/cache/clear]]? [[card]]
  ...
  card-next-schedule:: 2026-06-28T20:49:21.184Z
  card-last-reviewed:: 2026-06-24T06:49:21.184Z
  card-last-score:: 5
	- ## [[My Answer]]
		...
		- Cache clear does **not** uninstall, but [[Symlink]]ed [[mise/Backend]]s may need [[mise/install]] after a full clear.
			- #### [[My Question]]s
				- TODO  which backends use symlinks into the build cache?
				- TODO are symlinks here related to [[mise/Shim]]s at all?
				- TODO explain what "symlinked backends" means here
			- DONE fix the other flashcard about how to uninstall all commands in mise
	- ## [[AI Answer]]
