...
prev:: [[Launchpad/Pro Mk3 User Guide/06 Note Mode/03 Scale Mode]]
next:: [[Launchpad/Pro Mk3 User Guide/06 Note Mode/05 Overlap]]
- # 6.4 Note Mode Settings
	...
	- 6.4.A — Note Mode settings grid
		- ![Note Mode settings](../assets/Launchpad___Pro-Mk3-User-Guide___06-Note-Mode___04-Note-Mode-Settings___01-Settings-Grid.png)
	- Press the Chromatic/Scale toggle to switch between Chromatic (dim red) and Scale (bright green). Overlap changes how successive rows share notes; see [[Launchpad/Pro Mk3 User Guide/06 Note Mode/05 Overlap]].
