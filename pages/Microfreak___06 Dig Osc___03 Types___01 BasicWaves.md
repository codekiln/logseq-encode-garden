...
- # 06.03.01 Basic Waves Oscillator (BasicWaves)
	...
	- The four basic waveforms developed in the early days of synthesis are sine, triangle, square, and sawtooth. Each has a different mix of even and odd harmonics. The sine wave is the simplest, with only a fundamental. In a triangle wave, odd and even harmonics are distributed evenly. A square wave has only odd harmonics. To some ears, a square wave sounds more musical than a sawtooth, which contains all harmonics.
