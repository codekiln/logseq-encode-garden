- # clilint 0.0.2 plan
	...
	- ## Accepted choices
		...
		- CI checks that the OpenSpec skill source was generated by the same OpenSpec version managed by the project, so a CLI update cannot leave older agent instructions unnoticed.
