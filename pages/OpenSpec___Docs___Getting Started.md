# [OpenSpec Getting Started Docs](https://github.com/Fission-AI/OpenSpec/blob/main/docs/getting-started.md)
	...
	- It's also confusing because not all [[AI/Coding/Tool]]s support the [[UX/Pattern/Text Input/Slash Command]] pattern; for example, [[Codex/CLI]] does not. So what are we to do in Codex?
	-