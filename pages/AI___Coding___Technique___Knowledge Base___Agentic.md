...
- # #Agentic #[[Knowledge Base]] #[[Software Library]] #Documentation as an input to #[[AI Coding]]
	- Services like [[Devin]] (see its [[DeepWiki]]) and [[Blitzy]] seem to rely upon some automated, agentic documentation generation as an intermediary step.
		...
		- In the case of [[Blitzy]], this involves work on internal, private codebases.
	- ## #[[Mermaid Diagram]]
		-
