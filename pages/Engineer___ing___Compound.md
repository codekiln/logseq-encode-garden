...
- # Compound engineering
	...
	- ## Tooling
		- Primary stack at Every includes [[Claude/Code]], [[Codex/CLI]], and Factory [[Droid]]; packaged for others as [[Every/GitHub/compound-engineering-plugin]] ([[Codex/Plugin]] marketplace: `EveryInc/compound-engineering-plugin`).
	- ## Sources
