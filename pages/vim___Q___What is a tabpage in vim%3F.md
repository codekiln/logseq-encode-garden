...
- # What is a tabpage in [[vim]]? [[card]]
	- ## [[AI Answer]]
		- [[AI/Response]]
			...
			- **Short answer:** A **tabpage** is vim's highest-level workspace container — it holds one or more **windows**, which are viewports onto **buffers**.
			...
			- **When to use tabs:** tabpages let you maintain separate window layouts for distinct tasks (e.g., editing one module vs. reviewing another) without disrupting either layout when switching.
