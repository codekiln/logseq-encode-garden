...
- # 06.03.05 Karplus-Strong (KarplusStr)
	- Karplus Oscillator Model
		- ![01 Karplus Oscillator Model](../assets/Microfreak___06-Dig-Osc___03-Types___05-KarplusStr___01-Karplus-Oscillator-Model.png)
	...
	- ## Plaits oscillator models
		- The oscillator models in this group were developed by Mutable Instruments, who permitted their open-source designs to be implemented in the MicroFreak. Their waveforms were introduced in 2018 with the Plaits module.
		- In the MicroFreak, the corresponding Plaits parameters are named:
			- **Wave** → Harmonics
			- **Timbre** → Timbre
			- **Shape** → Morph
		- The knob names here differ from the names in the Plaits documentation. See the [Plaits manual](https://mutable-instruments.net/modules/plaits/manual/) for in-depth descriptions.
