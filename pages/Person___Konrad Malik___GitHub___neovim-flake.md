...
- # [konradmalik/neovim-flake: standalone neovim flake with my configuration](https://github.com/konradmalik/neovim-flake)
	- Standalone [[nvim]] flake for Konrad Malik's editor configuration.
	- Topics: development, dotfiles, [[nvim]], [[Nix]].
	- GitHub metadata at import: Lua; 20 stars; 2 forks; pushed 2026-04-24.
