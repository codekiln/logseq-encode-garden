...
- # A fast way to write, maintain, and publish a Logseq garden
	...
	- ## Working with a coding agent
		...
		- Proposed command examples:
			- ~~~text
			  ...
			  ~~~
		- `garden page resolve` reports whether the name matched a page title, an alias, or a reference-only page. It includes source locations and any competing matches. An ambiguous alias needs a decision from the caller; a fuzzy spelling suggestion remains a suggestion.
	...
	- ## Help a person understand an edit before committing it
		...
		- The person or coding agent decides whether the reported change is wanted. The command also reports uncertainty when it cannot confidently match a moved block.
		- ~~~text
		  Save an edit
		       |
		       v
