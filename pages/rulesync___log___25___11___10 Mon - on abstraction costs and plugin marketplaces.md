## High Level Reflections
	- Cory Doctorow's books (particularly [[Person/Cory Doctorow/Book/25/Picks & Shovels]] and [[Person/Cory Doctorow/Book/25/Enshittification]]) have taught me that [[Interop]] tools like `rulesync` are important because in the age of AI, vendor lock-in is likely to become a serious issue. [[pandoc]] could serve as an example for how to do an interop tool like `rulesync`
