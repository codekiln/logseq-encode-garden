...
description: >-
  ...
  its own `[[My Note]]` or `[[AI Notes]]` child bullet in italics with
  properly nested follow-on bullets. Use when the user asks to format, clean
  up, restructure, or "make it match my style" for an [[LV4AD/Ch/...]] page
  that already has raw/flat highlights. Does not fetch new highlights
  (lv4ad-1-import-chapter) and does not add links to other garden entities
