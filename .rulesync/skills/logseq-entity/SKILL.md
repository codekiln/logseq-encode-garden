...
description: >-
  ...
  asked, and record graph edits in today's journal (Filed / Updated).
...
targets: ["*"]
codexcli:
  short-description: Logseq entity registry, dedupe, create, journal extract, Filed/Updated after graph edits
---
