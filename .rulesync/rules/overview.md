...
- `tools/` - Contains utility scripts and tools (gitignored; separate repositories)
- `.rulesync/**/*.md` - AI instruction files managed by [dyoshikawa/rulesync](https://github.com/dyoshikawa/rulesync) which are compiled into config files for tools like Claude Code
