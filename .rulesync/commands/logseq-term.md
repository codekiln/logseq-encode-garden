...
targets:
  - '*'
description: Create or update a Logseq Term page with deduplication, minimal default structure, and a journal entry
argument-hint: Term name (required); optional namespace/context; optional aliases
---
