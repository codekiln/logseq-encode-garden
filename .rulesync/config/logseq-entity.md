...
3. **This file** — only when those pages are missing, incomplete, or the workspace has no graph copy yet.
...
- Propose or create **`[[Logseq/Entity]]`** and the **`[[Logseq/Entity/<Type>]]`** pages the author wants—**do not** recreate long per-type catalogs in this file.
